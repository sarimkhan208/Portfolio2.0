        ...
        <div className='mt-10 mr-3 ' >
            ...
            <RouterLink to='/projects' >
                <button  className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                    ...
                    <div className='text-lg ml-3 font-semibold text-white'>Projects</div>
                </button>
            </RouterLink>
            ...
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                ...
                <div className='text-lg ml-3 font-semibold text-white'>Skills</div>
            </button>
            </RouterLink>
            ...
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                ...
                <div className='text-lg ml-3 font-semibold text-white'>Toolsets</div>
            </button>
            </RouterLink>

            <RouterLink to='/contacts' >
            <button className='flex hover:bg-gray-900 w-full rounded-md p-2 mb-4'>
                <RiContactsFill className='text-2xl text-white' />
                <div className='text-lg ml-3 font-semibold text-white'>Contact</div>
            </button>
            </RouterLink>
            ...
            <button onClick={() => {
                ...
                <div className='text-lg ml-3 font-semibold text-white'>
                    <a href={sarim} download={"Mohd-Sarim-Khan-Resume"} >Resume</a>
                </div>
            </button>
        </div>
